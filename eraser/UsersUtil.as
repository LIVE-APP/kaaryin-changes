...
// Kaaryin changes for Streamed View
	...
	public static var _isStream:Boolean;

	public static function get isStream():Boolean {
		return _isStream;
	}
			
	public static function set isStream(val:Boolean):void {
		_isStream = val
	}
	
	//	 Kaaryin changes for Eraser
	
	public static var _isEraser:Boolean;
	
	public static function get isEraser():Boolean {
		return _isEraser;
	}
	
	public static function set isEraser(val:Boolean):void {
		_isEraser = val
	}
